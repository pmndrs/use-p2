...
export default class PlatformController extends RaycastController {
    ...
    calculatePlatformMovement(deltaTime: number): Duplet {
        ...
        const distanceBetweenWaypoints = vec2.distance(globalWaypoints[this.fromWaypointIndex], globalWaypoints[toWaypointIndex])
        ...
        vec2.lerp(newPos, globalWaypoints[this.fromWaypointIndex], globalWaypoints[toWaypointIndex], easedPercentBetweenWaypoints)
